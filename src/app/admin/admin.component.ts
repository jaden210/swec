...
export class AdminComponent implements OnInit {
  ...
  public buildDays() {
    ...
    for (let index = -5; index <= 15; index++) {
      ...
      // day.isBlackout = this.blackouts.some(b => moment(b.startTime).isSame(day.day, "day")) || !aDay.isOpen;
      this.days.push(day);
    }
    this.loading = false;   
  ...
  public navContact(appointment): void {
  ...
  public setView(view: string): void {
    this.view = this.views.find(v => v == view);    
    if (this.view == 'appointments') {
      setTimeout(() => {
